...
activities = {
    ...
    "Volleyball Club": {
        "description": "Volleyball practice focused on technique and teamwork",
        "schedule": "Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 16,
        "participants": ["henry@mergington.edu", "mia@mergington.edu"]
    },
    "Theater Group": {
        "description": "Acting classes and school play productions",
        "schedule": "Mondays, 3:30 PM - 5:00 PM",
        "max_participants": 18,
        "participants": ["charlotte@mergington.edu", "james@mergington.edu"]
    },
    "Painting Workshop": {
        "description": "Explore drawing and painting techniques with different materials",
